...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <nav className="w-full px-3 sm:px-8 py-2.5 sm:py-3 flex flex-col md:flex-row md:items-center justify-between gap-2 md:gap-4 z-20 relative border-b-2 border-black/10">
        {/* Row 1 on Mobile / Left+Right on Desktop */}
        <div className="w-full md:w-auto flex items-center justify-between gap-2">
          {/* Left: Brand Logo */}
          <div className="flex items-center gap-2 shrink-0 z-10">
            <div className="border-3 sm:border-4 border-black p-1 sm:p-2 px-2 sm:px-3 bg-black text-white font-black text-sm sm:text-xl md:text-2xl tracking-tighter shadow-[2px_2px_0px_0px_#000000] sm:shadow-[3px_3px_0px_0px_#000000]">
              Potenza RAG
            </div>
          ...
          {/* Mobile-only Action Buttons (Aligned to top-right of mobile header) */}
          <div className="flex md:hidden items-center gap-1 shrink-0">
            {/* Latency Score Button */}
            <button
              type="button"
              onClick={() => {
                audioFX.playClick(440);
              ...
              className={`font-mono text-[11px] font-bold uppercase px-2 py-1 border-2 border-black transition-colors cursor-pointer flex items-center gap-1 hard-shadow-xs ${
                isLatencyModalOpen
                  ? 'bg-black text-white'
            ...
            >
              ...
              <span
                className="px-1 py-0.2 border border-black text-[9px] font-black text-black"
            ...
            <button
              ...
              className="font-mono text-[11px] font-bold uppercase bg-white hover:bg-black hover:text-white text-black px-2 py-1 border-2 border-black transition-colors cursor-pointer hard-shadow-xs"
            >
              LOGS ({history.length})
            </button>
          </div>
        ...
        <div className="w-full md:w-auto flex items-center justify-between md:justify-end gap-1.5 sm:gap-2 z-10">
          ...
          <div className="w-full md:w-auto flex items-center justify-between border-2 border-black bg-white p-0.5 hard-shadow-xs" title="Select Voice & Answer Language">
            {[
              ...
              <button
                ...
                className={`flex-1 md:flex-initial font-mono text-[10px] sm:text-xs font-black px-1.5 sm:px-2 py-1 transition-colors cursor-pointer text-center ${
                  selectedLang === l.code
                    ? 'bg-black text-white'
          ...
          <button
            ...
            className="hidden sm:flex font-mono text-xs font-bold uppercase bg-white hover:bg-black hover:text-white text-black px-2.5 py-1.5 border-2 border-black transition-colors cursor-pointer items-center gap-1 hard-shadow-xs"
          ...
          {/* Latency Score Toolbar Button (Desktop) */}
          <button
            type="button"
            onClick={() => {
              audioFX.playClick(440);
          ...
          <button
            ...
            className="hidden md:flex font-mono text-xs font-bold uppercase bg-white hover:bg-black hover:text-white text-black px-2.5 py-1.5 border-2 border-black transition-colors cursor-pointer hard-shadow-xs"
          >
            LOGS ({history.length})
          </button>
        </div>
